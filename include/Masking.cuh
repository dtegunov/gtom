...
void d_HannMaskBorderDistance(tfloat* d_input, tfloat* d_output, int3 dims, tfloat falloff, int batch = 1);
void d_HammingMaskBorderDistance(tfloat* d_input, tfloat* d_output, int3 dims, tfloat falloff, int batch = 1);