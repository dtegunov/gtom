...
namespace gtom
{
	...
	*/
	void d_LocalStd(tfloat* d_map, int3 dimsmap, tfloat* d_fouriermask, tfloat localradius, tfloat* d_std, tfloat* d_mean = NULL, cufftHandle planforw = NULL, cufftHandle planback = NULL);
