...
rem ********************************************************************
set COMPILER=nvcc
set COMPFLAGS=-gencode=arch=compute_52,code=sm_52 -c --compiler-options=/GR,/W0,/EHs,/D_CRT_SECURE_NO_DEPRECATE,/D_SCL_SECURE_NO_DEPRECATE,/D_SECURE_SCL=0,/DMATLAB_MEX_FILE,/nologo,/openmp,/MDd,/D_SECURE_SCL=1,/D_ITERATOR_DEBUG_LEVEL=2
...
set LINKER=link
set LINKFLAGS=/dll /export:%ENTRYPOINT% /LIBPATH:"%LIBLOC%" libmx.lib libmex.lib libmat.lib gpu.lib cudart.lib cufft.lib cublas.lib curand.lib "..\x64\Debug\GTOM.lib" /MACHINE:X64 /nologo /manifest /incremental:NO /implib:"%LIB_NAME%.x" /MAP:"%OUTDIR%%MEX_NAME%%MEX_EXT%.map"
set LINKOPTIMFLAGS=
