...
TEST(Resolution, LocalFSCBfac)
{
	...
	//Case 1:
	{
		HeaderMRC header = ReadMRCHeader("E:\\mazdak\\masked_run1_half1_class001_unfil.mrc");
		...
		ReadMRC("E:\\mazdak\\masked_run1_half1_class001_unfil.mrc", &h_mrcraw1);
		ReadMRC("E:\\mazdak\\masked_run1_half2_class001_unfil.mrc", &h_mrcraw2);
		...
		d_LocalFSCBfac(d_input1, d_input2, dimsvolume, d_resolution, d_bfac, d_corrected, d_unsharpened, windowsize, 0.4f, 10, header.pixelsize.x / header.dimensions.x, -500, 0, -1.34f, true);
		...
		d_LocalStd(d_unsharpened, dimsvolume, 5, d_stdunsharp);
		d_LocalStd(d_corrected, dimsvolume, 5, d_stdsharp);
		...
		d_WriteMRC(d_resolution, dimsvolume, "E:\\mazdak\\bee\\resolution_aniso.mrc");
		d_WriteMRC(d_bfac, dimsvolume, "E:\\mazdak\\bee\\bfac_aniso.mrc");
		d_WriteMRC(d_corrected, dimsvolume, "E:\\mazdak\\bee\\corrected_aniso.mrc");
		d_WriteMRC(d_unsharpened, dimsvolume, "E:\\mazdak\\bee\\unsharpened_aniso.mrc");
		d_WriteMRC(d_normalized, dimsvolume, "E:\\mazdak\\bee\\normalized_aniso.mrc");
